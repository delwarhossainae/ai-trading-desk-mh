const PROVIDER_MESSAGE = 'Market data API is not configured. Add MARKET_DATA_PROVIDER=twelvedata and MARKET_DATA_API_KEY in backend environment variables.';
...
function resolveSymbol(request = {}) {
  ...
  return map[request.asset] || map[request.assetLabel] || request.marketDataSymbol || request.asset || 'XAU/USD';
}
...
module.exports = { getMarketData, PROVIDER_MESSAGE, DEFAULT_SYMBOL_MAP, INTERVAL_MAP };