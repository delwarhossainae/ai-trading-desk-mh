  ...
  try {
    ...
    if (error.name === 'AbortError') {
      return {
        ...
        message: CALENDAR_TIMEOUT_MESSAGE,
        errorCode: 'ECONOMIC_EVENTS_TIMEOUT',
        asset: getAssetConfig(request.asset)?.canonicalAsset || request.asset,
        events: [],
        riskSummary: CALENDAR_TIMEOUT_MESSAGE,
...
module.exports = { getEconomicEvents, getEconomicCalendarStatus, CALENDAR_MESSAGE, CALENDAR_PROVIDER_ERROR, CALENDAR_TIMEOUT_MESSAGE, ASSET_EVENT_FILTERS };
